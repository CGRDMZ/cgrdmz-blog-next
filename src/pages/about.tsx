        ...
        <div>
          <div className="flex flex-col sm:flex-row justify-start items-center">
            ...
            <div className="w-11/12 sm:w-1/2 text-gray-800 my-5 tracking-normal">
              <h1 className="text-4xl font-bold border-b-2 border-gray-600 w-3/5 pb-0.5 line">
                About Me
              </h1>
              <p className="text-gray-600 mt-2">
                My name is Çağrı, I am 22 years old. I was born in Erzurum,
                ...
                development and beside of that i was learning C language.
                Starting from that I have never stopped learning new things and
                technologies. Because of the interests I have as a child, I have
                decided to enter a university. After the university entrance
                exam, I have got into Dokuz Eylül University, Computer Science
                Department.
              </p>
            </div>
          </div>
