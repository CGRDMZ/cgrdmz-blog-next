...
export default function Post({
  ...
  return (
    <article className="flex flex-col filter drop-shadow transform transition-all duration-75 ease-in-out sm:hover:-translate-y-1 sm:hover:shadow-xl rounded-lg overflow-hidden flex-grow ">
      ...
      <div className="bg-white flex flex-col justify-start p-6 max-w-3xl w-full">
